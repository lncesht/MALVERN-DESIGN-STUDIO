    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-warm-100 via-warm-50 to-primary-100">
      ...
      <div className="container-custom relative z-10 text-center px-4 py-16 sm:py-20 md:py-24">
        <div className="max-w-5xl mx-auto animate-fade-in">
          ...
          <h1 className="heading-xl text-brown-900 mb-4 sm:mb-6 leading-tight px-2" style={{ fontFamily: "'Cinzel', serif", letterSpacing: '0.15em' }}>
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-brown-700 mb-8 sm:mb-10 md:mb-12 max-w-3xl mx-auto leading-relaxed px-4">
            Explore a curated collection of   artwork that pushes boundaries and inspires creativity
          </p>
